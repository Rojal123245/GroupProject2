...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2018 at 03:04 PM
...
--
ALTER TABLE `patmanagement`
  MODIFY `pat_id` int(9) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `patmanagement`
  ADD CONSTRAINT `fk_sta_pat` FOREIGN KEY (`staff_id`) REFERENCES `staff` (`staffId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_stu_pat` FOREIGN KEY (`student_id`) REFERENCES `student` (`Stid`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
